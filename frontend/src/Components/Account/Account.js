...
function Account() {
    ...
    return (
        ...
        <div className={`account-page ${darkTheme ? 'account-dark-theme' : 'account-light-theme'}`}>
            <Navfield /> {/* Sidebar */}
            {/* Main Content */}
                    ...
                    <div className="account-settings-card account-profile-card">
                        ...
                        <div className="account-form-grid">
                            <div className="account-form-group">
                                ...
                                <input type="text" defaultValue="Savindya Wickramasinghe" placeholder="Enter your full name" />
                            </div>
                            <div className="account-form-group">
                                <label>
                                    <FaUser className="account-field-icon" />
                                ...
                                <input type="email" defaultValue="savindya@epicgreen.com" placeholder="Enter your email" />
                            </div>
                            <div className="account-form-group">
                                <label>
                                ...
                                <input type="text" defaultValue="Field Officer" disabled />
