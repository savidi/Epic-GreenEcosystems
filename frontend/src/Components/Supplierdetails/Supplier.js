                  ...
                  <tr key={row.key} className={idx % 2 === 0 ? "sup-row-light" : "sup-row-dark"}>
                    ...
                    <td>
                      <div className="sup-actions">
                        <button className="sup-btn" onClick={() => navigate(`/UpdateSpice/${row._id}`)}><EditOutlined /> Update Spices</button>
                        <button className="sup-btn" onClick={() => navigate(`/Supdet/${row._id}`)}><EditOutlined /> Update Details</button>
                        <button className="sup-btn sup-btn-secondary" onClick={() => deleteHandler(row._id)}><DeleteOutlined /> Delete</button>
                      </div>
                    </td>
                  </tr>
                ))
